...
/**
 * Observes or adjusts one logical agent request without changing the calling screen.
 *
 * It wraps invoke(), stream(), postJson(), or streamSse() once, even when the client retries the underlying HTTP call.
 * Use it for tracing, safe header injection, request metrics, or logging that must follow the whole user action.
 *
...
interface RequestMiddleware
{
    ...
    /**
     * Observe the final user outcome once, after success, cancellation, or the last failed retry.
