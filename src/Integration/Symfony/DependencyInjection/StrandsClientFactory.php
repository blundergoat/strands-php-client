...
/**
 * Factory for creating StrandsClient instances in Symfony applications.
 *
 * Registered as a service in Symfony's DI container by StrandsExtension.
 * Each agent service uses this factory to create its StrandsClient.
 */
