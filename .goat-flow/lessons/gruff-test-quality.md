...
`.goat-flow/footguns/gruff-php.md`, `.goat-flow/lessons/gruff-php.md`, and
`.goat-flow/patterns/gruff-php.md`.
...
**Caveat:** when splitting, be careful not to collide with existing test
names. We tripped on `testDifferentPathsProduceDifferentSignatures` already
existing for a different scenario; renamed our new one to
